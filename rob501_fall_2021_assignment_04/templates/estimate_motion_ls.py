...
def estimate_motion_ls(Pi, Pf, Si, Sf):
    ...
    for i in np.arange(Pi.shape[1]):
        ...
        wj = 1/(det(Si[:,:,i]) + det(Sf[:,:,i]))  #the weights are declared as the inverse of the sum of the determinants of the initial and final covariance matrices as per equation 14 in the cheng paper
